...
public class PL_10_04 {
    public PL_10_04() {
    }

    public static void main(String[] args) {
        Imovel imovel1 = new Imovel("\nRua da alegria", "Porto", 24, 1, 1, 100.0, 0.0, TipoImovel.CASA, TipoAcabamento.USADA);
        Imovel imovel2 = new Imovel("\nRua da alegria", "Porto", 24, 6, 10, 500.0, 0.0, TipoImovel.CASA, TipoAcabamento.USADA);
